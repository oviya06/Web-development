...
import cc from '../images/c1.webp';
import ccc from '../images/cc.webp';
import kri from '../images/kri.webp';
import sum from '../images/sum.webp';
...
//popup-end
        ...
        <div>
            ...
            <div style={{padding:20}}>
                <Stack direction="row" spacing={2} className='b1'>
                    ...
                    <CardMedia sx={{height:150,weight:150}} image={kri}/>
                    <CardContent>
                    ...
                    <CardMedia sx={{height:150,weight:150}} image={ccc}/>
                    <CardContent>
                    Kutty<br/>
                    Rs. 269.00
                    <div sx={{'& > legend': { mt: 2 },}}>
                    ...
                    <Card sx={{maxHeight:350,maxWidth:350}}>
                    <CardMedia sx={{height:150,weight:150}} image={cc}/>
                    <CardContent>
                    SuperStar petti<br/>
                    Rs. 569.00
                    <div sx={{'& > legend': { mt: 2 },}}>
                    ...
                    <Card sx={{maxHeight:350,maxWidth:350}}>
                    <CardMedia sx={{height:150,weight:150}} image={sum}/>
                    <CardContent>
    ...
    <React.Fragment className='bb1'>
      ...
      <BootstrapDialog onClose={handleClose} open={open}>
        ...
        <DialogTitle sx={{ m: 2, p: 2 }} id="customized-dialog-title">SuperStar petti</DialogTitle>
        <Typography style={{textAlign:'center'}}>Rs. 269.00<br/>Quantity:250gm</Typography>
