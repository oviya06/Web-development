...
import Muruku from '../images/ThattaiMurukku2.webp';
...
//popup-end
        ...
        <div>
            ...
            <div style={{padding:20}}>
                <Stack direction="row" spacing={2} className='b1'>
                    ...
                    <CardMedia sx={{height:150,weight:150}} image={Muruku}/>
                    <CardContent>
                    ThattaiMurukku<br/>
                    Rs. 269.00
                    <div sx={{'& > legend': { mt: 2 },}}>
    ...
    <React.Fragment className='bb1'>
      ...
      <BootstrapDialog onClose={handleClose} open={open}>
        ...
        <DialogTitle sx={{ m: 2, p: 2 }} id="customized-dialog-title">Tamilnadu Tomato Pickle</DialogTitle>
