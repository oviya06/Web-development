...
import Halwa from '../images/TirunelveliHalwa.webp';
import Coffee from '../images/coffee.webp';
import hon from '../images/honey.webp';
...
//popup-end
        ...
        <div>
            ...
            <div style={{padding:20}}>
                <Stack direction="row" spacing={2} className='b1'>
                    ...
                    <CardMedia sx={{height:150,weight:150}} image={Halwa}/>
                    <CardContent>
                    Halwa<br/>
                    Rs. 269.00
                    <div sx={{'& > legend': { mt: 2 },}}>
                    ...
                    <CardMedia sx={{height:150,weight:150}} image={hon}/>
                    <CardContent>
                    Honey<br/>
                    Rs. 209.00
                    <div sx={{'& > legend': { mt: 2 },}}>
                    ...
                    <Card sx={{maxHeight:350,maxWidth:350}}>
                    <CardMedia sx={{height:150,weight:150}} image={Coffee}/>
                    <CardContent>
                    Filter Coffee<br/>
                    Rs. 69.00
                    <div sx={{'& > legend': { mt: 2 },}}>
    ...
    <React.Fragment className='bb1'>
      ...
      <BootstrapDialog onClose={handleClose} open={open}>
        ...
        <DialogTitle sx={{ m: 2, p: 2 }} id="customized-dialog-title">Filter Coffee</DialogTitle>
        <Typography style={{textAlign:'center'}}>Rs. 69.00<br/>Quantity:250gm</Typography>
